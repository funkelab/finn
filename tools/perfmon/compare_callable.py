...
parser.add_argument(
    "callable",
    help="The name of the callable to plot excluding the module (e.g. "
    "QtDimSliderWidget._value_changed).",
)
parser.add_argument(
    "baseline",
    default="baseline",
...
logging.info(
    "Running compare_callable.py with the following arguments.\n{args_}",
    extra={"args_": args},
)
