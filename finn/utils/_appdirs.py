...
user_data_dir: Callable[[], str] = partial(appdirs.user_data_dir, _appname, _appauthor)
...
user_state_dir: Callable[[], str] = partial(appdirs.user_state_dir, _appname, _appauthor)
user_log_dir: Callable[[], str] = partial(appdirs.user_log_dir, _appname, _appauthor)
