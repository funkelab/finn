...
class QtGraphControls(QtLayerControls):
    """Qt view and controls for the finn Graph layer.
    """

    layer: 'finn.layers.Graph'
    ...
    def __init__(self, layer) -> None:
        ...
        action_manager.bind_button(
            'finn:activate_graph_select_mode', self.select_button
        )
        # self.addition_button = QtModeRadioButton(layer, 'add_points', Mode.ADD)
        # action_manager.bind_button(
        #     'finn:activate_graph_add_mode', self.addition_button
        # )
        ...
        action_manager.bind_button(
            'finn:activate_graph_pan_zoom_mode', self.panzoom_button
        )
        ...
        # )
        # action_manager.bind_button(
        #     'finn:delete_selected_graph_points', self.delete_button
        # )
