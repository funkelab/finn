...
from finn.layers import Labels, Layer, Points, Shapes, Tracks, Vectors
...
def center_cross_on_mouse(
    ...
    if not getattr(viewer_model, "mouse_over_canvas", True):
        # There is no way for finn 0.4.15 to check if mouse is over sending canvas.
