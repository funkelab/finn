...
# viewer = finn.view_image(data, order=(1, 0, 2), contrast_limits=(18000, 40000), multiscale=True)
viewer = finn.view_image(data, contrast_limits=(18000, 40000), multiscale=True)
